      ...
      return (
        <div ref={ref} className={cn(cardVariants({ variant, className }))} {...props}>
          ...
          <div className='relative w-full border-x border-zinc-400 dark:border-zinc-700'>
            <div className='absolute z-0 grid h-full w-full items-center'>
              <section className='absolute z-0 grid h-full w-full grid-cols-2 place-content-between'>
                <div className='rounded-full outline-8 dark:outline-gray-950 sm:my-6 md:my-8 size-1 my-4 outline-gray-50 bg-[#007fff] -translate-x-[2.5px]' />
                <div className='rounded-full outline-8 dark:outline-gray-950 sm:my-6 md:my-8 size-1 my-4 outline-gray-50 bg-[#007fff] translate-x-[2.5px] place-self-end' />
                <div className='rounded-full outline-8 dark:outline-gray-950 sm:my-6 md:my-8 size-1 my-4 outline-gray-50 bg-[#007fff] -translate-x-[2.5px]' />
                <div className='rounded-full outline-8 dark:outline-gray-950 sm:my-6 md:my-8 size-1 my-4 outline-gray-50 bg-[#007fff] translate-x-[2.5px] place-self-end' />
              </section>
            </div>
