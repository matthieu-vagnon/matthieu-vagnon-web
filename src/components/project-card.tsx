...
export default function ProjectCard({
  ...
  return (
    <Magnetic intensity={0.07} className='h-75 sm:h-90 md:h-100 w-55 sm:w-70 md:w-80'>
      <Link
        href={url}
      ...
      >
        ...
        <div className='flex flex-row items-baseline gap-1 sm:gap-2 max-w-full'>
          <h3 className='text-lg sm:text-xl md:text-2xl font-bold text-white z-1 font-sans-special overflow-x-hidden text-ellipsis whitespace-nowrap'>
            {project.title}
          </h3>
