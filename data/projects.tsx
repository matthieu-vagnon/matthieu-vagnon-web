...
export const projects: Record<string, Project> = {
    ...
    longDescription: {
      en: (
        <span>
          ...
          <Highlight color='gray'>React and Next.js</Highlight> letting you watch my case studies, my profile, contact
          me and access my links in a simple way on <Highlight color='gray'>mobile and desktop</Highlight>.
        </span>
      ),
      fr: (
        <span>
          Une <Highlight color='gray'>application web portfolio</Highlight> faite avec{' '}
          <Highlight color='gray'>React et Next.js</Highlight> vous permettant de regarder mes études de cas, mon
          profil, me contacter et accéder à mes liens de manière simple sur{' '}
          <Highlight color='gray'>mobile et desktop</Highlight>.
        </span>
      ),
      ja: (
        <span>
          <Highlight color='gray'>React et Next.js</Highlight>で作られたシンプルな
          <Highlight color='gray'>ポートフォリオウェブアプリケーション</Highlight>
          で、私のケーススタディ、プロフィールの閲覧、連絡先やリンクへのアクセスが
          <Highlight color='gray'>モバイルとデスクトップ</Highlight>で簡単にできます。
        </span>
      )
    },
    tags: {
  ...
  'smart-interview': {
    ...
    longDescription: {
      ...
      fr: (
        <span>
          Une plateforme pour créer des <Highlight color='gray'>questionnaires alimentés par l&apos;IA</Highlight>. Un
          questionnaire est créé en utilisant le <Highlight color='gray'>builder</Highlight> intégré ou en important un{' '}
          <Highlight color='gray'>fichier JSON</Highlight>. Le questionnaire est ensuite envoyé au public et les
          réponses peuvent être analysées dans la même application pour{' '}
          <Highlight color='gray'>cibler leur audience optimale</Highlight>. L&apos;IA ajoute automatiquement des
          questions contextuelles au questionnaire lorsque l&apos;utilisateur répond pour ajouter un maximum de détails
          à l&apos;analyse.
        </span>
      ),
      ja: (
        <span>
          <Highlight color='gray'>AI駆動のアンケート</Highlight>を作成するためのプラットフォーム。統合された
          <Highlight color='gray'>ビルダー</Highlight>を使用するか、<Highlight color='gray'>JSONファイル</Highlight>
    ...
    problem: {
      en: (
        <span>
          The challenge of this project was to make the user experience pleasant. Having reached a stage where the core
          features were already in production, it naturally took me some time to get familiar with the code. The
          situation: a <Highlight color='red'>UX that needed work</Highlight>,{' '}
          <Highlight color='red'>simplistic and somewhat outdated UI</Highlight>,{' '}
          <Highlight color='red'>missing essential front-end features</Highlight> but huge potential (talented back-end
          engineers had already been recruited for the application and were doing good work).
        </span>
      ),
      fr: (
        <span>
          Le défi de ce projet était de rendre l&apos;expérience d&apos;utilisation agréable. Étant arrivé à un stade où
          les fonctionnalités de base étaient déjà en production, il m&apos;a naturellement fallu un petit peu de temps
          pour m&apos;imprégner du code. L&apos;état des lieux : une <Highlight color='red'>UX à revoir</Highlight>,
          l&apos;
          <Highlight color='red'>UI simpliste et un peu démodée</Highlight>, des{' '}
          <Highlight color='red'>fonctionnalités front essentielles manquantes</Highlight> mais un potentiel énorme (des
          ingénieurs back-end talentueux avaient déjà été recrutés pour l&apos;application et faisaient du bon boulot).
        </span>
      ),
      ja: (
        <span>
    ...
    results: {
      en: (
        <span>
          ...
          <Highlight color='gray'>intuitive</Highlight>, <Highlight color='gray'>consistent</Highlight> and lets users{' '}
          <Highlight color='gray'>save time</Highlight> and <Highlight color='gray'>resources</Highlight> while creating{' '}
          <Highlight color='gray'>complex questionnaires</Highlight>. Sales were boosted by{' '}
          <Highlight color='gray'>fewer bugs</Highlight>, a <Highlight color='gray'>better appearance</Highlight> and a{' '}
      ...
      fr: (
        <span>
          ...
          <Highlight color='gray'>intuitive</Highlight>, <Highlight color='gray'>consistante</Highlight> et permet aux
          ...
          <Highlight color='gray'>questionnaires complexes</Highlight>. Les ventes ont été stimulées par{' '}
          <Highlight color='gray'>moins de bugs</Highlight>, une <Highlight color='gray'>meilleure apparence</Highlight>{' '}
          et une <Highlight color='gray'>meilleure UX perçue</Highlight>.
        </span>
      ),
      ja: (
        <span>
          アプリケーションはより<Highlight color='gray'>ユーザーフレンドリー</Highlight>で、
          <Highlight color='gray'>直感的</Highlight>で、<Highlight color='gray'>一貫性があり</Highlight>、ユーザーは
          <Highlight color='gray'>複雑なアンケート</Highlight>を作成しながら<Highlight color='gray'>時間</Highlight>と
          <Highlight color='gray'>リソース</Highlight>を節約できるようになりました。
          <Highlight color='gray'>バグが少なく</Highlight>、<Highlight color='gray'>見た目が改善され</Highlight>、
          <Highlight color='gray'>UXの体験が向上した</Highlight>ことで 売上も伸びました。
        </span>
      )
    },
    relatedUrls: [
  ...
  'koryori-ya': {
    ...
    longDescription: {
      en: (
        <span>
          ...
          their adress thanks to a <Highlight color='gray'>map</Highlight> and letting people{' '}
          <Highlight color='gray'>call them</Highlight> easily.
        </span>
      ),
      fr: (
        <span>
          Une application web simple pour un <Highlight color='gray'>restaurant japonais</Highlight> présentant leur
          adresse grâce à une <Highlight color='gray'>carte</Highlight> et permettant aux personnes de{' '}
          <Highlight color='gray'>les appeler</Highlight> facilement.
        </span>
      ),
      ja: (
        <span>
          <Highlight color='gray'>日本料理店</Highlight>のシンプルなウェブアプリケーションで、
          <Highlight color='gray'>地図</Highlight>で住所を表示し、 簡単に
          <Highlight color='gray'>電話をかける</Highlight>ことができるようにしました。
        </span>
      )
    },
    tags: {
    ...
    problem: {
      en: (
        <span>
          The challenge of this project was clearly to design a clean interface and develop a dynamic and interactive
          page in a <Highlight color='red'>very short timeframe (~ 1 week before restaurant opening)</Highlight> while
          needing to <Highlight color='red'>limit infrastructure costs</Highlight> (and thus without using &quot;drag
          and drop&quot; tools).
        </span>
      ),
      fr: (
        <span>
          Le défi de ce projet à clairement été de concevoir un design propre et de développer une page dynamique et
          interractive en un{' '}
          <Highlight color='red'>temps très réduit (~ 1 semaine avant ouverture du restaurant)</Highlight> tout avec le
          besoin de
          <Highlight color='red'>limiter les dépenses d&apos;infrastructure</Highlight> (et donc sans l&apos;utilisation
          d&apos;outils &quot;drag and drop&quot;).
        </span>
      ),
      ja: (
        <span>
          このプロジェクトの課題は、<Highlight color='red'>非常に短い期間（レストランのオープン前の約1週間）</Highlight>
    ...
    results: {
      en: (
        <span>
          The application is now <Highlight color='gray'>used in production</Highlight> and works perfectly well. The{' '}
          ...
          <Highlight color='gray'>UX is pleasant</Highlight>, all in record time. The site is public so feel free to
          visit it (link below).
        </span>
      ),
      fr: (
        <span>
          L&apos;application est maintenant <Highlight color='gray'>utilisée dans la production</Highlight> et
          fonctionne parfaitement. La <Highlight color='gray'>carte charge bien</Highlight> et l&apos;
          <Highlight color='gray'>interface est propre</Highlight>. La{' '}
          <Highlight color='gray'>appel à l&apos;action est clair</Highlight> et l&apos;
          <Highlight color='gray'>UX est agréable</Highlight>, tout cela en un temps record. Le site est public donc
          n&apos;hésitez pas à le visiter (lien ci-dessous).
        </span>
      ),
      ja: (
        <span>
          アプリケーションは現在<Highlight color='gray'>本番環境で使用され</Highlight>、完璧に動作しています。
    ...
    longDescription: {
      en: (
        <span>
          ...
          <Highlight color='gray'>TotalEnergies</Highlight> as Predictive Layer was bought in 2023~2024.
        </span>
      ),
      fr: (
        <span>
          Une plateforme pour visualiser et gérer des{' '}
          <Highlight color='gray'>outils de trading alimentés par l&apos;IA</Highlight> initialement créée pour
          <Highlight color='gray'>Predictive Layer</Highlight> et maintenant activement utilisée par{' '}
          <Highlight color='gray'>TotalEnergies</Highlight> suite au rachat de Predictive Layer en 2023~2024.
        </span>
      ),
      ja: (
        <span>
          <Highlight color='gray'>Predictive Layer</Highlight>向けに最初に作成され、2023年〜2024年にPredictive
          Layerが買収されたことにより、現在は<Highlight color='gray'>TotalEnergies</Highlight>が積極的に使用している
          <Highlight color='gray'>AI駆動の取引ツール</Highlight>を表示および管理するプラットフォーム。
        </span>
      )
    },
    tags: {
    ...
    problem: {
      ...
      fr: (
        <span>
          ...
          <Highlight color='red'>grande quantité de données</Highlight> sous forme de{' '}
          <Highlight color='red'>graphiques</Highlight> sans{' '}
          <Highlight color='red'>surcharger l&apos;utilisateur</Highlight>
        </span>
      ),
      ja: (
        <span>
          このプロジェクトの課題は、<Highlight color='red'>大量のデータ</Highlight>を
          <Highlight color='red'>グラフ</Highlight>の形で表示しながら、ユーザーに
          <Highlight color='red'>過度な負担をかけない</Highlight>ようにすることでした。
        </span>
      )
    },
    solution: {
    ...
    results: {
      ...
      fr: (
        <span>
          ...
          <Highlight color='gray'>données se chargent bien</Highlight> et l&apos;
          <Highlight color='gray'>interface est claire</Highlight>.
        </span>
      ),
      ja: (
        <span>
          このツールは現在TotalEnergiesのチームによって<Highlight color='gray'>本番環境で使用されており</Highlight>
          、完璧に動作しています。<Highlight color='gray'>データが正常に読み込まれ</Highlight>、
